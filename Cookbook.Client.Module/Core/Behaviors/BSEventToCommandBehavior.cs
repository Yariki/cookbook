...
namespace Cookbook.Client.Module.Core.Behaviors
{
    public class BSEventToCommandBehavior : Behavior<FrameworkElement>
    {
        #region [need]
        ...
        public BSEventToCommandBehavior()
        {
        }
        ...
        public static DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(ICommand),
                                                                                       typeof(BSEventToCommandBehavior),
        ...
        {
            var beh = (BSEventToCommandBehavior)o;
